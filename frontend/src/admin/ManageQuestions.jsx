...
export default function ManageQuestions() {
        ...
        <div className="modal-overlay">
          <div className="modal-content">
            ...
            <form onSubmit={handleBulkSubmit} className="admin-form">
              <div className="form-group">
                <label style={{ fontSize: '12px', color: 'var(--primary)', marginBottom: '8px', display: 'block' }}>JSON ARRAY INPUT</label>
                <textarea
                  value={bulkJson}
                  ...
                  placeholder='[
  {
    ...
    "answer": "..."
                  ...
                  style={{ minHeight: '300px', fontFamily: '"Fira Code", monospace', fontSize: '13px', lineHeight: '1.6' }}
                  required
                ></textarea>
              </div>
              ...
              <div className="modal-actions">
                ...
                <button type="submit" className="save-btn">Upload Questions</button>
              </div>
            </form>
          </div>
        </div>
